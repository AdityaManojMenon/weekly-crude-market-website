...
export const briefs: WeeklyBrief[] = [
  {
    ...
    tradeIdeas: [
      {
        ...
        conviction: "HIGH",
        rationale: "Brent-WTI spread at $9.03 remains well above the $5.57 3M average. Maritime disruption risk, sanctions enforcement, and tanker-flow uncertainty continue to support seaborne crude, while the U.S. crude surprise build keeps pressure on WTI. In a controlled stalemate, Brent can stay bid while WTI lags. Headline-sensitive trade — size appropriately.",
        entry: "Spread > $8.50",
        target: "$10.50–11.50 spread",
        stop: "< $7.00 spread",
      },
      {
        structure: "Short Near-Term Crude Volatility (Short OVX / Sell Premium)",
        conviction: "MEDIUM",
        rationale: "OVX at 79.4 (89th percentile) reflects expensive fear premium. If tensions stabilize without fresh escalation or peace breakthrough, implied volatility can compress faster than realized moves. Best expressed through defined-risk short premium structures and smaller sizing due to geopolitical gap risk.",
        entry: "OVX > 75 / elevated short-dated premium",
        target: "OVX 60–65 / 20–30% premium decay",
        stop: "OVX > 90 or confirmed escalation headline",
      },
    ],
    keyLevels: [
    ...
    scenarios: [
      ...
      },
      {
        ...
        probability: 30,
        direction: "neutral",
        description: "Product strength and backwardation support dips near $92–94, while crude builds and de-escalation cap rallies near $99–100. WTI remains volatile but contained in a $92–99 range with headline-driven swings.",
        trigger: "Mixed EIA reports · Spread holds $4–6 · No major geopolitical catalyst",
      },
    ],
    catalysts: [
