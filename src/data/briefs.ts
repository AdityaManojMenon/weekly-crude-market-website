...
export const briefs: WeeklyBrief[] = [
  {
    ...
    bias: "BEARISH",
    biasNote: "Event Override — Ceasefire",
    regime: "TRANSITIONAL",
    ...
    executiveSummary:
      "WTI enters the week in a post-spike, transitional regime, where strong physical fundamentals are being offset by normalization in geopolitical risk premium. A historically bullish inventory report and continued product tightness supported the recent rally, but the majority of this upside has already been priced in, with WTI advancing sharply to ~$104 and the Brent–WTI spread compressing to ~$5.5. The market is now shifting from trend to digestion, with near-term direction driven less by fundamentals and more by the evolution of the ceasefire narrative. Trading strategy should prioritize tactical execution over directional conviction — fading strength into extensions and selectively engaging on pullbacks — while maintaining disciplined risk management in an environment where geopolitical headlines can rapidly reprice the market.",
    inventory: {
    ...
    tradeIdeas: [
      {
        structure: "Short WTI — Tactical Fade on Exhaustion Spike",
        conviction: "HIGH",
        rationale: "WTI has repriced sharply higher on geopolitical risk and strong physical data, but current levels ($106–112) reflect peak fear and positioning extension rather than new information. With no incremental escalation, price is vulnerable to risk premium decay and positioning unwind, even if underlying fundamentals remain supportive. The setup is a conditional fade: sell into strength with defined risk above the breakout zone. Executed via MCL (Micro Crude Oil) contracts — on a $200k account, 1R = $2,000. Two standard CL contracts at this stop distance would risk ~6.5% of portfolio, which is too aggressive. 3 MCL contracts (~$800/contract risk at $107 entry) keeps total exposure within the 1R limit and maintains sound risk management.",
        entry: "0.5R @ $107 · 0.5R @ $110–112 (extension / panic spike zone) · Instrument: MCL (3 contracts) — not CL",
        target: "T1: $100 (60% of position) · T2: $97 (30%) · T3: $92 runner (10%)",
        stop: "$115 daily close (invalidates fade — implies fresh escalation or structural breakout)",
      },
      {
        structure: "Bear Call Spread — Short WTI Volatility Fade",
        conviction: "MEDIUM",
        rationale: "WTI is in a post-spike transitional regime where $110+ levels reflect peak risk premium and extended positioning. As price stabilizes, the current regime favors monetizing the rapid decay of elevated implied volatility (Vega) and time (Theta). A Bear Call Spread effectively expresses this tactical fade, offering a defined-risk profile that profits from consolidation or modest downside without requiring a heavy directional move. Execution: Enter only upon signs of exhaustion — stalling momentum or failed breakouts above $112.",
        entry: "0.5R @ $110–112 zone (exhaustion confirmation only) · Sell 112 Call / Buy 117 Call · Expiry: 30–45 DTE",
        target: "50–60% of premium captured · Exit full position on target — do not overstay for full decay",
        stop: "WTI daily close > $115 · OR OVX re-expands above ~85 · OR new geopolitical escalation headline",
      },
    ],
    keyLevels: [
      { price: "$104.39",       label: "WTI — Week Close / Current Reference",                        type: "pivot" },
      { price: "$107.00",       label: "T1 · Short WTI Fade — Entry 1 (0.5R)",                       type: "resistance" },
      { price: "$110–112",      label: "T1/T2 · Short WTI + Bear Call Spread — Entry Zone",          type: "resistance" },
      { price: "$112",          label: "T2 · Bear Call Spread — Short Strike",                        type: "resistance" },
      { price: "$115.00",       label: "T1/T2 · Shared Stop — Structural Breakout Invalidation",     type: "resistance" },
      { price: "$117",          label: "T2 · Bear Call Spread — Long Strike (Max Loss Boundary)",    type: "resistance" },
      { price: "$100.00",       label: "T1 · Short WTI — Target 1 (60% exit)",                       type: "support" },
      { price: "$97.00",        label: "T1 · Short WTI — Target 2 (30% exit)",                       type: "support" },
      { price: "$92.00",        label: "T1 · Short WTI — Target 3 Runner (10%)",                     type: "support" },
      { price: "$5.46",         label: "Brent-WTI — Current Spread (Normal Range, post-compression)", type: "pivot" },
      { price: "> $8.00",       label: "Brent-WTI — Re-escalation Alert Level",                      type: "resistance" },
      ...
      { price: "OVX 74.9",      label: "Vol — PANIC REVERSING · T2 Stop if OVX > 85",               type: "pivot" },
    ],
    scenarios: [
      {
        title: "Bullish Case — Ceasefire Breaks / Fresh Escalation",
        probability: 25,
        direction: "bull",
        description: "The ceasefire fails or a new supply disruption (Hormuz incident, fresh OPEC+ cut) re-injects geopolitical risk premium. Brent-WTI spread widens back toward $8–10, Brent leads higher, and WTI follows toward $110–115. Bullish inventory data provides a durable floor; physical tightness amplifies any geopolitical shock.",
        trigger: "Ceasefire collapse · Strait of Hormuz incident · OPEC+ emergency cut · Iranian supply outage",
        probabilityNote: "WTI > $110 / Fresh geopolitical shock",
      },
      {
        title: "Bearish Case — Ceasefire Holds, Premium Fully Unwinds",
        probability: 45,
        direction: "bear",
        description: "Ceasefire durability is confirmed, geopolitical risk premium continues to decay, and WTI fades from $104 toward $95–100 as the war bid expires. Even if inventory draws continue, the removal of the premium cap means price action is governed by softer macro and supply normalization. OVX continues lower, confirming fear unwinding.",
        trigger: "Sustained ceasefire · No new supply disruption · OPEC+ compliance loosens · Brent-WTI compresses below $4 · OVX breaks below 65",
        probabilityNote: "WTI $95–100 / Geopolitical normalization",
      },
      {
        title: "Base Case — Consolidation $100–106",
        probability: 30,
        direction: "neutral",
        description: "WTI consolidates in the $100–106 range as bullish physical data (all-category draws, strong backwardation, elevated crack spreads) provides a floor, while ceasefire normalization and the already-large weekly rally cap further upside. Price action is two-way and headline-driven rather than trend-following. The Brent-WTI spread oscillates in the $4.50–6.50 range.",
        trigger: "Mixed EIA data · Ceasefire holds without collapse · Brent-WTI stable $4.50–6.50 · OVX drifts lower toward 65–70",
        probabilityNote: "WTI $100–106 / Consolidation",
      },
    ],
    catalysts: [
      { date: "May 7",  label: "EIA WPSR",              detail: "Can inventory draws sustain a third consecutive bullish week? Key for $107+ breakout vs fade",            type: "eia" },
      { date: "May 7",  label: "FOMC Rate Decision",    detail: "Fed rate decision — DXY reaction will impact commodity complex; rate cut = bullish crude",                  type: "fed" },
      { date: "May 2",  label: "Non-Farm Payrolls",     detail: "U.S. labor market read-through on demand outlook — strong NFP supports consumption / WTI demand",           type: "macro" },
      { date: "Live",   label: "Ceasefire Durability",  detail: "Any breakdown re-injects geopolitical risk premium and Brent spread rapidly — monitor daily",               type: "geo", isLive: true },
      { date: "May",    label: "OPEC+ Production Policy", detail: "Ongoing compliance and quota watch — any surprise cut would re-accelerate the rally",                    type: "opec" },
    ],
    riskDashboard: {
      upsideRisks: [
        "Ceasefire breakdown / Hormuz re-escalation widens Brent spread",
        "Third consecutive bullish inventory sweep confirms structural tightening",
        "OPEC+ surprise emergency production cut",
        "Dollar weakens further (DXY below 96) boosting commodity prices",
        "NFP surprise / risk-on macro pushes energy higher",
      ],
      downsideRisks: [
        "Ceasefire holds — geopolitical war premium fully expires, WTI fades",
        "Inventory builds return after large seasonal draw distortion",
        "WTI already priced in bullish data — limited incremental upside at $104",
        "OPEC+ compliance loosens / production ramps into price strength",
        "Macro slowdown / demand destruction from sustained high prices",
      ],
      riskScore: 3,
      riskLabel: "Mixed / Event-Driven",
      volatility: "HIGH",
      conviction: "MEDIUM",
    ...
    outlook:
      "Directional Bias: Bearish (Event Override). Despite a historically strong inventory week — all four categories drew materially above consensus — the CEASEFIRE event override dominates the forward outlook. WTI has rallied +$13.54 to $112.39 in a couple of days, capturing the majority of the bullish physical upside. The Brent-WTI spread collapse to $5.46 confirms the relative value trade worked and the war premium has largely normalized. Going forward, the path of least resistance is consolidation or modest fade unless a fresh geopolitical catalyst emerges. Avoid chasing longs at current levels; wait for prices to overheat into unstable geopolitically-driven territory and effectively implement risk-averse shorting mechanisms to capture profits on the fade. Monitor ceasefire developments daily.",
