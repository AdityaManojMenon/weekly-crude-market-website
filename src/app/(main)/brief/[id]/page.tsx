      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            { label: "3-2-1 Crack", value: `$${brief.crackSpreads.crackSpread321}/bbl`, sub: `${fmtChange(brief.crackSpreads.crackSpreadChange)} WoW`, dir: brief.crackSpreads.crackSpread321 > 30 ? "bull" : "bear", Icon: Factory },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-8" style={{ minHeight: 860 }}>
        ...
        <div className="rounded-xl p-5 flex flex-col" style={{ background: "var(--card)", border: "1px solid var(--border)" }}>
          ...
          {brief.curveStructure.brentWtiHistory ? (
            <BrentWtiChartWrapper
              data={brief.curveStructure.brentWtiHistory}
              currentSpread={brief.curveStructure.brentWtiSpread}
            />
          ) : (
          ...
          <div className="mt-3 pt-3 text-xs leading-relaxed flex flex-col gap-1.5"
            ...
            <div>
              ...
              {brief.curveStructure.brentWtiSpread > 6
                ...
                ? "Narrow Brent premium — WTI near parity. No significant supply dislocation at Cushing. Watch for re-widening as a signal of renewed crude-specific pressure."
          ...
          <div style={{ marginBottom: 20 }}>
            ...
            >
              <MacroDualAxisChartWrapper
                ...
                currentWti={last.wti}
                currentIndicator={last.realYield}
                indicatorUnit="%"
                interpretation={
              ...
              <MacroDualAxisChartWrapper
                ...
                currentWti={last.wti}
                currentIndicator={last.breakeven}
                indicatorUnit="%"
                interpretation={
        ...
        <div className="flex flex-col gap-6 h-full">
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="flex-1">
              <SpreadMiniChartWrapper data={brief.curveStructure.spreadHistory} currentSpread={brief.curveStructure.spread} structure={brief.curveStructure.structure} compact />
            </div>
          </div>
        </div>
